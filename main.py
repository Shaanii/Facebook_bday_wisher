...
imagesFolder=r'/home/shivani/apache-tomcat7/wtpwebapps/testfb/img/FB'
images={}
imageCount=0
...
for i in range(0,imageCount):
    ...
    for j in range(0,fps*6):       
        ...
        if(i==1):
            cv2.putText(currentImage,'Its a Special', (70,(int)(vheight/3)),cv2.FONT_HERSHEY_TRIPLEX,3,(128,128,128),6)
            cv2.putText(currentImage,'Day', (vwidth/3,(int)(vheight/3+120)),cv2.FONT_HERSHEY_TRIPLEX,3,(128,128,128),6)
        ...
        if(i==2 and j>2*fps):
            ...
            if(j<3*fps):
                ...
                cv2.putText(base,'From Your Friend', (base.shape[1]/2,(int)(vheight/2+240)),cv2.FONT_HERSHEY_COMPLEX_SMALL,2,(128,128,128),4)
                currentImage=base
            video.write(currentImage)
